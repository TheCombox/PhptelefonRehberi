...
<div class="menu">
  <div class="title" onclick="f()">Kişi Listeleme <span class="fa fa-bars"></span>
    <div class="arrow"></div>
  </div>
  <div class="dropdown">
    <p ><a href="/islev/Listelehepsi.php">Tümünü listele <span class="fa fa-inbox"></span>
    <p><a href="/VeriListele.php">Arama ile Listele <span class="fa fa-gear"></span>
